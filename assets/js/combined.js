...
panes.main = {
	...
	"安装": {
		"介绍":			"installation/instructions.html",
		"下载":				"installation/download.html",
		"更新":				"installation/upgrade.html",
...
panes.core = {
	"Classes": {
		...
		"Asset": {
			...
			"高级":			"classes/asset/advanced.html"
		},
		"Autoloader":	"classes/autoloader.html",
		"Cache": {
			"配置":	"classes/cache/config.html",
			"用法":			"classes/cache/usage.html",
			"高级":			"classes/cache/advanced.html"
		},
		"Cli":			"classes/cli.html",
		"Config":		"classes/config.html",
		"Cookie":		"classes/cookie.html",
		"Crypt": {
			"配置":	"classes/crypt/config.html",
			"用法":			"classes/crypt/usage.html",
			"高级":			"classes/crypt/advanced.html"
		},
		"Database": {
			"简介":   	  "classes/database/introduction.html",
			"用法":          	  "classes/database/usage.html",
			"DB 类":       	  "classes/database/db.html",
			"DBUtil 类":   	  "classes/database/dbutil.html",
			"Query 构建":	{
				"简介":			"classes/database/qb.html",
				"Insert 构建":	"classes/database/qb_insert.html",
				"Select 构建":	"classes/database/qb_select.html",
				"Update 构建":	"classes/database/qb_update.html",
				"Delete 构建":	"classes/database/qb_delete.html",
				"Where 构建":	"classes/database/qb_where.html"
			}
		},
		...
		"Request": {
			"URI 请求":		"classes/request/request.html",
...
panes.oil = {
	"Oil": {
		...
		"产生":			"packages/oil/generate.html",
		"改善":			"packages/oil/refine.html",
		"套件":			"packages/oil/package.html",
		"测试":				"packages/oil/test.html",
		"控制台":			"packages/oil/console.html",
		"服务器":			"packages/oil/server.html"
	}
};
...
panes.auth = {
	"Auth 套件": {
		...
		"编写驱动":	"packages/auth/drivers.html",
		"驱动类型": {
...
panes.orm = {
	"Orm 套件": {
		...
		"创建模型":	"packages/orm/creating_models.html",
		"CRUD":				"packages/orm/crud.html",
		"关系模型": {
			"简介":	"packages/orm/relations/intro.html",
			"属于":	"packages/orm/relations/belongs_to.html",
			"一对一":		"packages/orm/relations/has_one.html",
			"一对多":		"packages/orm/relations/has_many.html",
			"多对多":	"packages/orm/relations/many_many.html"
		},
		"模型": {
			"软删除":        "packages/orm/model/soft.html",
			"临时/修订版本": "packages/orm/model/temporal.html",
			"集合套":         "packages/orm/model/nestedset.html"
		},
		"EAV 容器":		"packages/orm/eav.html",
		"观察者": {
			"简介":			"packages/orm/observers/intro.html",
			"包括观察者 ":	"packages/orm/observers/included.html",
			"自定义":		"packages/orm/observers/creating.html"
		}
	}
};
